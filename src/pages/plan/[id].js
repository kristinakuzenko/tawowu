                        ...
                        <div className="">
                            <div className="container-fluid detail-plan">
                                <div className="box col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                    <h1 className="place-h">Days: {info[0].days} </h1>
                                </div>
                                <div className="box col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                    <h1 className="place-h">{info[0].byCar}</h1>
                                </div>
                                <div className="box col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                    <h1 className="place-h">{info[0].price} $</h1>
                                </div>
                                <div className="box col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                    <h1 className="place-h">{info[0].dist / 1000} km </h1>
                                </div>
                                <div className="box col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                    <h1 className="place-h">{info[0].places.length} places </h1>
                                </div>
                                <div className="box col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                    <h1 className="place-h">4 hours</h1>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="plan-description ">
                                                <div className="one-place">
                                                    ...
                                                    <div className="container-fluid ">
                                                        ...
                                                        <div className=' place-div  col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8' >
                                                            <h1 className="place-h">Price </h1>
                                                            <h1 className="place-p">{route.place.price}</h1>
                                                            <h1 className="place-h">Location</h1>
                                                            <h1 className="place-p">{route.place.location}</h1>
                                                            <Link href={`/place/${route.place.name}`}>
                                                            <h1 className="place-details">Click for more details </h1>
                                                            </Link>
                                                        </div>
                                                    </div>
